...
def main():
    ...
    #Save output to csv files
        with open('BMI_dev_kl_measurements.csv','ab') as ofile:
            writer=csv.writer(ofile)
            writer.writerow(kl_measurements)
        with open('BMI_dev_max_error_measurements.csv','ab') as ofile:
            writer=csv.writer(ofile)
            writer.writerow(max_error_measurements)
        with open('BMI_dev_mse_measurements.csv','ab') as ofile:
            writer=csv.writer(ofile)
